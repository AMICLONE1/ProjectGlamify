...
export const metadata: Metadata = {
  ...
  description: "The terms under which you may use Glamify's products and services.",
  alternates: { canonical: "/terms" },
};

const sections = [
  { heading: "Acceptance", body: "By creating a Glamify account or using our services, you agree to these terms. If you're agreeing on behalf of a business, you represent that you have authority to bind that business." },
  { heading: "Your account", body: "You're responsible for maintaining the security of your account credentials and for all activity that occurs under your account. Notify us immediately of any unauthorized access at security@glamify.in." },
  ...
  { heading: "Acceptable use", body: "You may not use Glamify to send unsolicited communications, store unlawful content, attempt to bypass our security controls, or compete directly with Glamify by reverse-engineering our service." },
  { heading: "Your content", body: "You retain all rights to client data, business information, and content you upload to Glamify. You grant us a limited license to process that content solely to deliver the service." },
