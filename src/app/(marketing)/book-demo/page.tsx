...
export const metadata: Metadata = {
  title: "Get started — Clitell",
  description:
    "Tell us about your business. Our team reaches out within 24 hours, sets up your storefront, and gives you a full walkthrough. No payment required.",
...
const benefits = [
  ...
  { title: "Live within 48 hours", body: "From your first message to your first online booking in under 2 days." },
  { title: "Full walkthrough included", body: "We'll show you booking, billing, CRM, and AI insights — tailored to your business type." },
        ...
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-16 items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <p className="mt-6 text-base sm:text-lg text-muted leading-relaxed max-w-md">
              ...
              sets up your storefront, walks you through the platform, and hands
              you the keys. You start taking bookings — we handle the rest.
            </p>
