...
export const pricingFaqs: Faq[] = [
  ...
  { q: "Do you offer non-profit or small business discounts?", a: "Registered non-profits and women-led salons in Tier-2/3 cities get 30% off paid plans for the first year. Email info@powernetpro.com with proof of registration." },
];
